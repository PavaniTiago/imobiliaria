                        ...
                        <CarouselItem key={idx}>
                            <Card>
                                <CardContent className="flex aspect-video items-center justify-center w-full">
                                    <Image key={idx} src={imovel.imageUrl[1]} alt="imagem de imóvel" className="h-full w-full object-cover rounded-lg relative" width={0} height={0} objectFit="cover" sizes="100vw" quality={100} priority/>
